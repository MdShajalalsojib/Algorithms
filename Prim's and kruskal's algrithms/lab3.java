...
public class lab3 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < m; i++) {
            ...
            u--; v--; // If input is 1-based, make it 0-based
            g.addEdge(u, v, w);
        }
        ...
        // Proper MST counting is not implemented
        System.out.println("Note: Number of distinct MSTs calculation is not implemented.");
    }
}
